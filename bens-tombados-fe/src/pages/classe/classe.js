...
const headCells = [
  { id: 'idClasse', numeric: true, disablePadding: false, label: 'ID Classe' },
  { id: 'nomeClasse', numeric: false, disablePadding: true, label: 'Nome Classe' },
                ...
                visibleRows.map((row) => (
                  ...
                  >
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                      ...
                      <IconButton
                        color="primary"
                        onClick={() => navigate(`/adicionar-classe/${row.idClasse}`)}
                        sx={{ marginLeft: 1 }}
                      >
                    ...
                    <TableCell align="center">
                      {Array.isArray(row.subclasses) && row.subclasses.length > 0
                        ? row.subclasses.map((subclasse) => subclasse.nomeSubclasse).join(', ')
                        : 'Sem subclasses'}
                    </TableCell>
                  </TableRow>
                ))
